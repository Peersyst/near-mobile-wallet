...
sed -i "3s/.*/var process = require('process');\n/" ./node_modules/pbkdf2/browser.js
# sed -i "4s/.*/var Buffer = require('buffer').Buffer;/" ./node_modules/pbkdf2/browser.js
...
# sed -i '19s/.*/\nvar Buffer = require("buffer").Buffer;/' ./node_modules/@ckb-lumos/hd/lib/keystore.js
...
# sed -i '17s/.*/\nvar Buffer = require("buffer").Buffer;/' ./node_modules/@ckb-lumos/hd/lib/mnemonic/index.js
sed -i '8s/.*/var _crypto = _interopRequireDefault(require("react-native-expo-crypto"));/' ./node_modules/@ckb-lumos/hd/lib/keychain.js
sed -i '15s/.*/\nvar Buffer = require("buffer").Buffer;/' ./node_modules/@ckb-lumos/hd/lib/keychain.js
