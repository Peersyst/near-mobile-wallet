import { CKBBalance, Transaction, Nft, DepositInDAOParams, SendTransactionParams, DAOBalance, DAOUnlockableAmount,
    WithdrawAndUnlockParams } from "./CkbServiceMock.types";
